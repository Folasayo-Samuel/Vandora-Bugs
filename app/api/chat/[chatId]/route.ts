...
// import jwt, { Secret, GetPublicKeyOrSecret, JwtPayload } from 'jsonwebtoken';
...
// Function to decode and validate the authentication token
// const validateAuthToken = async (token: string): Promise<User | null> => {
//     try {
//       const secret: Secret | GetPublicKeyOrSecret = process.env.NEXTAUTH_SECRET || '';
...
//     // const user = await prismadb.user.findOne({where: {id: userId} });
